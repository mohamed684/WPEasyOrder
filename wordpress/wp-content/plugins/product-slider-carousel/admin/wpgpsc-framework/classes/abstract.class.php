 ...
 *
 */
if ( ! class_exists( 'WPGPSC_Abstract' ) ) {
  abstract class WPGPSC_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        WPGPSC::$css = apply_filters( "wpgpsc_{$this->unique}_output_css", WPGPSC::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'WPGPSC_Field_' . $field_type;
