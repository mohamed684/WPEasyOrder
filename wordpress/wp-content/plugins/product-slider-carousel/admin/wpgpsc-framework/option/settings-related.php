...
WPGPSC::createSection(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'id'       => 'wpgpscsc_related_slider_show',
				'type'     => 'switcher',
			...
			array(
				...
				'dependency' => array( 'wpgpscsc_related_slider_show', '==', 'false' ),
			),
			array(
				'id'       => 'wpgpscsc_has_upsell_products',
				'type'     => 'checkbox',
			...
			array(
				'id'       => 'wpgpscsc_related_before_upsells',
				'type'     => 'checkbox',
			...
			array(
				'id'         => 'wpgpscsc_related_section_title_show',
				'type'       => 'switcher',
			...
			array(
				'id'         => 'wpgpscsc_related_section_title_text',
				'type'       => 'text',
				...
				'dependency' => array( 'wpgpscsc_related_section_title_show', '==', 'true' ),
			),
			array(
				'id'       => 'wpgpscsc_related_products_from',
				'type'     => 'button_set',
				'title'    => __( 'Products Show From', 'gpsc-product-slider-carousel' ),
				'subtitle' => __( 'Set the taxonomy where you want to show products form.', 'gpsc-product-slider-carousel' ),
				'options'  => array(
					'category' => __( 'Category', 'gpsc-product-slider-carousel' ),
					'tag'      => __( 'Tag', 'gpsc-product-slider-carousel' ),
					'both'     => __( 'Both', 'gpsc-product-slider-carousel' ),
				),
				'default'  => 'category',
			),
			...
			// Slider Settings.
			array(
				'id'       => 'wpgpscsc_related_slider_speed',
				'type'     => 'spinner',
			...
			array(
				'id'       => 'wpgpscsc_related_slider_autoplay',
				'type'     => 'switcher',
			...
			array(
				'id'         => 'wpgpscsc_related_slider_autoplay_delay',
				'type'       => 'spinner',
				...
				'unit'       => 'ms',
				'default'    => 5000,
				'dependency' => array( 'wpgpscsc_related_slider_autoplay', '==', 'true' ),
			),
			array(
				'id'       => 'wpgpscsc_related_slider_loop',
				'type'     => 'switcher',
			...
			array(
				'id'       => 'wpgpscsc_related_slides_per_view',
				'type'     => 'spinner',
			...
			array(
				'id'          => 'wpgpscsc_related_product_details_padding',
				'type'        => 'spacing',
			...
			array(
				'id'       => 'wpgpscsc_related_add_to_cart_button_colors',
				'type'     => 'color_group',
			...
			array(
				'id'       => 'wpgpscsc_related_slides_space_between',
				'type'     => 'spinner',
			...
			array(
				'id'         => 'wpgpscsc_related_slider_navigation',
				'type'       => 'switcher',
			...
			array(
				'id'         => 'wpgpscsc_related_slider_nav_icon',
				'type'       => 'button_set',
				...
				'default'    => 'f105',
				'dependency' => array( 'wpgpscsc_related_slider_navigation', '==', 'true' ),
			),
			array(
				'id'         => 'wpgpscsc_related_slider_nav_colors',
				'type'       => 'color_group',
			...
			array(
				'id'         => 'wpgpscsc_related_slider_pagination',
				'type'       => 'switcher',
			...
			array(
				'id'         => 'wpgpscsc_related_slider_pagination_type',
				'type'       => 'button_set',
				...
				'default'    => 'bullets',
				'dependency' => array( 'wpgpscsc_related_slider_pagination', '==', 'true' ),
			),
			array(
				'id'         => 'wpgpscsc_related_slider_pagination_colors',
				'type'       => 'color_group',
