...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.wpgpsc_gutenberg_blocks ) { return; }

  Object.values(window.wpgpsc_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'wpgpsc-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary wpgpsc-shortcode-button',
              onClick: function () {
                window.wpgpsc_gutenberg_props = props;
              },
            }, block.button_title ),
