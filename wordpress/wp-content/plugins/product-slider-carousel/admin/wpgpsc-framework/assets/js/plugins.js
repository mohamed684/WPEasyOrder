...
(function($) {
  ...
  function WPGPSCAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WPGPSCAjaxChosen.prototype.init = function() {
  ...
  WPGPSCAjaxChosen.prototype.events = function() {
  ...
  WPGPSCAjaxChosen.prototype.search_field_focused = function() {
  ...
  WPGPSCAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WPGPSCAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('wpgpsc-chosen', _this.options.data).done( function( response ) {
  ...
  WPGPSCAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wpgpsc-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.WPGPSCChosenOrder($hidden_value, true);
  ...
  $.fn.WPGPSCAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WPGPSCAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WPGPSCAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WPGPSCAbstractChosenOrder = (function() {

    function WPGPSCAbstractChosenOrder() {}

    WPGPSCAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WPGPSCAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WPGPSCAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WPGPSCAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WPGPSCAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WPGPSCAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WPGPSCAbstractChosenOrder.WPGPSCChosenOrder = function(select, order, force) {
    ...
    return WPGPSCAbstractChosenOrder;
  ...
  $.fn.extend({
    WPGPSCChosenOrder: function(order, force) {
      return _WPGPSCChosenOrder.WPGPSCChosenOrder(this, order, force);
    }
  });

  this._WPGPSCChosenOrder = (function(_super) {
    __extends(_WPGPSCChosenOrder, _super);

    function _WPGPSCChosenOrder() {
      _ref = _WPGPSCChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WPGPSCChosenOrder.relAttributeName = 'data-option-array-index';

    _WPGPSCChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WPGPSCChosenOrder.getDOMElement = function(element) {
    ...
    _WPGPSCChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WPGPSCChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WPGPSCChosenOrder;

  })(WPGPSCAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('wpgpsc-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('wpgpsc-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWPGPSC = FormSerializer.serializeObject;
    $.fn.serializeJSONWPGPSC   = FormSerializer.serializeJSON;
  }
